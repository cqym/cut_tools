				...
				try{
					Ext.Ajax.request({
								...
								success: function(response){
										...
										if(detail.length == 0){
											if(node == null){
												var win = new tsOSupplierWin({contract_code:record.get('quotationCode'),
												...
												var win = new tsOSupplierWin({quotationId:record.get('id'),
...
//							var node = this.tsOContractTree.getSelectionModel().getSelectedNode();
							try{
								...
								success: function(response){
										...
										var conEditWin = new Ext.ffc.ContractOutStockEditWindow(
											{
												outStockInfor:{quotationId:contractInforId,outStockType:6,status:0,quotationCode:quotationCode,outStockDetails:detail,memo:memo},
												listeners :{
													close : function(p){
														if(node == null){
															var win = new tsOSupplierWin({contract_code:record.get('quotationCode'),
