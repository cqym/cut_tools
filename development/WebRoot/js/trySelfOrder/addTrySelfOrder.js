...
//					{xtype:'textfield',  name: 'status',value:'编制',readOnly : true,x:100,y:62,width:170},
					...
					//6
					 ...
					 {xtype:'textfield' ,name: 'mome', width : 440, readOnly : this.isReadOnly,x:100,y:125},
					 //hidden
   ...
   this.show = function(){
       if(this.method != null){
	       this.method();
			...
			store.load();
			/**订单修改页面**/
			var win = new Ext.ls.trySelfOrder.addWin({orderId:this.id,detailFlag:true,URL:Ext.ls.trySelfOrder.updateUrl});
			/**设置窗口的标题**/
