...
Ext.ffc.PurchaseOrder.cOSupplierGrid = Ext.extend(Ext.grid.GridPanel,{
		...
		constructor : function(_cfg){
			...
			if(this.contractId){
				hpurl = PATH + "/contractOrder/supplierList.do?contractId=" + this.contractId + "&leaf="+this.leaf + "&brand=" + this.brand;
			}else if(this.quotationId){
			    hpurl = PATH + "/scheduleOrder/supplierList.do?qId=" + this.quotationId + "&leaf="+this.leaf+"&brand=" + this.brand;
