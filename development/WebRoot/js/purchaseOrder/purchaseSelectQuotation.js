 ...
 Ext.ffc.PurchaseOrder.QuotationSelectWindow = Ext.extend(Ext.Window,{
		...
		constructor : function(_cfg){
			...
			this.contract_list.on('rowdblclick',function(grid,rowIndex,e){
				...
				this.callBackMethod(record.get("id"),record.get("customerCode"),record.get("quotationCode"));
			},this);
      this.quoDetail.on('rowdblclick',function(grid,rowIndex,e){
				var r = grid.getStore().getAt(rowIndex);
				this.callBackMethod(record.get("id"),record.get("customerCode"),record.get("quotationCode"),r.get("productBrand"));
			},this);
