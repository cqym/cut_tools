		...
		constructor : function(_cfg){
			...
			this.lableStyle_ = "font-size:9pt;text-align:right;width:100px";
				...
				//
					...
					allowDecimals : false,allowNegative : false,decimalPrecision : 0,minValue : 0,maxValue : 100,x:900,y:123,width:170,value:0,
...
//						}
						var orderDetail = Ext.util.JSON.encode(childrenArray);
							Ext.apply(record.data,{'currencyId':this.nav3.updateGrid.currCombox.curid});
