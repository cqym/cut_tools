				...
				try{
						Ext.Ajax.request({
							...
							success: function(response){
									...
									{
										outStockInfor:{quotationId:contractInforId,userName:LoginInfor.user.trueName,customerCode:customerCode,customerName:customerName,outStockType:6,status:0,quotationCode:quotationCode,outStockDetails:detail,memo:memo},
										listeners :{
											close : function(p){
