	...
	constructor : function(_cfg) {
		...
		Customer.CustomerGrid.superclass.constructor.call(this, {
			...
			store : new Ext.data.JsonStore({
				...
				'accountNumber','taxCode','homePage','memo', 'id','closingAccountMode','lockStatus','qianKuanDate','qianKuanOverDate','qianKuanDay','reputationPeriod','sumAccount','sumContractMoney','reputationMoney']
			}),
			//sm : sm,
			columns : [//sm,
			    ...
			    {header:'reputationPeriod',dataIndex :'reputationPeriod'},
			    {header:'reputationMoney',dataIndex :'reputationMoney'}
			],
...
Customer.CustomerWindow = Ext.extend(Ext.Window, {
	...
	onSubmitClick : function() {
		...
		if(record.get('qianKuanOverDate') != null && record.get('qianKuanDay') > record.get('reputationPeriod')){
			var qianKuanJinE = record.get('sumContractMoney') - record.get('sumAccount');
