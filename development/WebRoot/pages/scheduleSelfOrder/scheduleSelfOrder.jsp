...
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/product.js"></script>
...
<script type="text/javascript" src="<%=path %>/js/scheduleSelfOrder/quotation.js"></script>
