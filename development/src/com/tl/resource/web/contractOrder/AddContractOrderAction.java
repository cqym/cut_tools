...
public class AddContractOrderAction extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    try {
      ...
      orderInfor.setOrderType(Integer.valueOf(orderType));
      ...
      orderInfor.setOrderCode(billsCodeDefService.getBillCode(buildCodeType(orderInfor.getOrderType()), supplier.getSupplierCode(), orderInfor
