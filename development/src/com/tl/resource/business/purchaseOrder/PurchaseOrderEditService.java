...
public class PurchaseOrderEditService {
  ...
  public OrderInfoDto consultContractInfor(String contractId, String supplierId, String brand, String leaf) {
    ...
    parmMap.put("contractCode", conInfor.getContractCode());
  ...
  public OrderInfoDto consultScheduleQuo(String scheduleQuoId, String supplierId, String brand, String leaf) {
    Integer orderType = OrderInfoDto.ORDER_TYPE_SCHEDLE;
    if ("0".equals(leaf)) {
      orderType = OrderInfoDto.ORDER_TYPE_SCHEDLE_SELF;
    }
    return consultQuotation(scheduleQuoId, supplierId, brand, orderType, OutStockInforDto.OUT_STOCK_TYPE_SCHEDULE_TQ, leaf);
  }
  ...
  public OrderInfoDto consultTryQuo(String tryQuoId, String supplierId, String brand, String leaf) {
    // TODO Auto-generated method stub
    Integer orderType = OrderInfoDto.ORDER_TYPE_TRY;
    if ("0".equals(leaf)) {
      orderType = OrderInfoDto.ORDER_TYPE_TRY_SELF;
    }
    return this.consultQuotation(tryQuoId, supplierId, brand, orderType, OutStockInforDto.OUT_STOCK_TYPE_TRY_TQ, leaf);
  }
  ...
  public void updatePurchaseOrder(OrderInfoDto dto) {
    ...
    TOrderInfor record = new TOrderInfor();
    ObjectUtil.copyObjectPropertys(dto, record);
    orderInforDao.updateByPrimaryKey(record);
